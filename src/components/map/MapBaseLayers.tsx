  ...
  return (
    <LayersControl position="topright" collapsed={false}>
      <LayersControl.BaseLayer checked name="Atlas">
        <TileLayer url={MAP_TILE_URLS.atlas} noWrap bounds={MAP_TILE_BOUNDS} minZoom={MAP_MIN_ZOOM} maxZoom={MAP_MAX_ZOOM} eventHandlers={{
          add: () => { map.getContainer().style.background = '#0FA8D2' },
        }} />
      </LayersControl.BaseLayer>
      <LayersControl.BaseLayer name="위성">
        <TileLayer url={MAP_TILE_URLS.satellite} noWrap bounds={MAP_TILE_BOUNDS} minZoom={MAP_MIN_ZOOM} maxZoom={MAP_MAX_ZOOM} eventHandlers={{
