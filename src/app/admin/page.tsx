    ...
    <div className="p-8 space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {cards.map(({ label, value, icon: Icon, href, color }) => {
          const content = (
            <div className="flex items-center justify-between rounded-xl border border-zinc-800 bg-zinc-900 p-5 transition-colors hover:border-zinc-700">
              <div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <Link href="/admin/characters?filter=unnamed" className="rounded-xl border border-amber-400/20 bg-amber-400/5 p-5 hover:bg-amber-400/10 transition-colors">
        ...
        <Link href="/admin/reports" className="rounded-xl border border-zinc-800 bg-zinc-900 p-5 hover:border-zinc-700 transition-colors">
