...
import { ArrowDown, ArrowUp, Check, LoaderCircle, Pencil, Plus, Trash2, Upload, X } from 'lucide-react'
import AppImage from '@/components/ui/AppImage'
import Select, { type SelectOption } from '@/components/ui/Select'
import { createClient as createSupabaseBrowserClient } from '@/lib/supabase/client'
import { createBongstagramPost, createBongstagramUploadUrl, deleteBongstagramPost, deleteBongstagramUploadedMedia, updateBongstagramPost } from './actions'
...
function PostEditRow({ post, character, profile }: { post: Post; character: Character; profile: Profile }) {
  const router = useRouter()
