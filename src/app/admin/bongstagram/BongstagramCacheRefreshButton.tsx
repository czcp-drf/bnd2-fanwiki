...
import { refreshBongstagramCache } from './actions'

export default function BongstagramCacheRefreshButton() {
  ...
  function handleRefresh() {
    ...
    startTransition(async () => {
      const result = await refreshBongstagramCache()
      if (result.success) {
