...
import { LayoutDashboard, FileText, Users, Building2, LogOut, Swords, GitFork, ShieldOff, Tv2, Map, Camera } from 'lucide-react'
...
const navItems = [
  ...
  { href: '/admin/bongstagram', label: 'Bongstagram 관리', icon: Camera },
